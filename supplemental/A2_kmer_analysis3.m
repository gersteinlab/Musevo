function kmer_analysis3
% no repetitions + normalization

% normalize to first in k-mer
...
save('data/kms_norm','km1','km2','km3','km4');
...
sgtitle('Km=2 normalized to first in kmer')

annotation('textbox', [0 0.83 1 0.1], ...
    'String', 'major reference chord', ...
    'EdgeColor', 'none', ...
    'HorizontalAlignment', 'center')

annotation('textbox', [0 0.4 1 0.1], ...
    'String', 'minor reference chord', ...
    'EdgeColor', 'none', ...
    'HorizontalAlignment', 'center')
